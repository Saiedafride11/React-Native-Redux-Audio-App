import { StyleSheet, View, SafeAreaView, ScrollView, Image, useWindowDimensions, Pressable } from 'react-native';
...
const CategoryBox = ({title, image, onPress}) => {
  return (
      <Pressable
          ...
          <Image source={image} style={{height: 150, width:150, top: -60}}/>
          <View
              style={{
                  alignItems: 'center',
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView>
        ...
        <View style={{backgroundColor: colors.black}}>
          <Image resizeMode="cover" style={{ height: 450, width:"100%"}} source={require('../../assets/images/home-banner.png')} />
          <View style={{position: "absolute", width: "100%", top: 100}}>
            <Text preset="h2" white centered>
              WELCOME
            </Text>
            <Text textColor={colors.grey} centered style={{width: width - 20, alignSelf: "center", marginTop: spacing[5]}}>
